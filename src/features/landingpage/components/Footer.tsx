...
const footerLinks = {
  Shop: ['New Arrivals', "Women's Fashion", "Men's Wear", 'Electronics', 'Home & Living', 'Sale'],
  Support: ['Help Center', 'Track Order', 'Returns & Refunds', 'Shipping Info', 'Size Guide', 'Contact Us'],
  Company: ['About Us', 'Careers', 'Press', 'Blog', 'Affiliates', 'Gift Cards'],
...
const socialLinks = [
  { Icon: FacebookIcon, label: 'Facebook', href: 'https://www.facebook.com/ShopNest' },
  { Icon: XIcon, label: 'Twitter / X', href: 'https://www.twitter.com/ShopNest' },
  { Icon: InstagramIcon, label: 'Instagram', href: 'https://www.instagram.com/ShopNest' },
  { Icon: LinkedInIcon, label: 'LinkedIn', href: 'https://www.linkedin.com/company/ShopNest' },
]
...
export function Footer() {
  return (
    <footer id="about" className="bg-muted/40 border-t">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            <a href="#" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl">ShopNest</span>
            </a>
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
              Your one-stop destination for curated fashion, electronics, and lifestyle products. Quality you can trust, prices you'll love.
            </p>
            {/* Social links */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} ShopNest Inc. All rights reserved.
          </p>
